...
import "./App.css"; // tus estilos de App
...
import Foto1 from "./Images/foto1.avif";
import Foto2 from "./Images/foto2.avif";
import Foto3 from "./Images/foto3.avif";
            ...
            {[1,2,3,4].map((i) => (
              <div key={i} className="col-6 col-md-3">
                <div className="position-relative d-inline-block">
                  <img src={Foto3} className="rounded-circle img-fluid circulo" alt="Estilista" />
