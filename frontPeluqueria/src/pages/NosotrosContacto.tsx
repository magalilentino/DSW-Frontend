...
import {
  ...
  EMAIL,
  GOOGLE_MAPS_LINK,
} from "../components/home/Constants.tsx";
    ...
    <div className="info-page">
      ...
      <div className="sobre-nosotros">
        ...
        <div className="nosotros-contenido">
          ...
          <div className="nosotros-texto">
            <p>
              En <strong>Peluquería Estilo & Belleza</strong>, nos apasiona
              ayudarte a resaltar tu estilo personal. Con más de una década de
              experiencia, ofrecemos cortes, coloraciones, tratamientos
              capilares y asesoramiento personalizado.
            </p>
            <p>
              Nuestro equipo de profesionales se capacita constantemente para
              brindarte las últimas tendencias y técnicas. Creemos que cada
              visita debe ser una experiencia relajante, renovadora y única.
            </p>
            <p>
              Valoramos la confianza que nuestros clientes depositan en nosotros
              y trabajamos cada día para superarnos. ¡Gracias por elegirnos!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="contacto">
        ...
        <p className="contacto-mensaje">
          ¿Tenés dudas, sugerencias o querés reservar un turno? ¡Estamos para
          ayudarte!
        </p>
