  ...
  const servicios = [
    {
      ...
      descripcion: "Corte moderno y personalizado",
    },
    {
      foto: Foto2,
      titulo: "Barbería",
      descripcion: "Afeitado y arreglo de barba profesional",
    },
    {
      foto: Foto3,
      titulo: "Coloración",
      descripcion: "Tintes y mechas con productos de calidad",
    },
  ];
